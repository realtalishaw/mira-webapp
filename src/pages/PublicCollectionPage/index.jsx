  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-4 gap-6 w-3/4 mx-auto'>
        ...
        {designs.map(design => (
          <DesignCard key={design.id} design={{ name: design.designName || 'Untitled', image: design.designImage, id: design.id, collection: collection?.collectionName }} isOwner={false} />
        ))}
      </div>
    </div>
  );
